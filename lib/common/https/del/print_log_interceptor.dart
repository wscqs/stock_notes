...
class PrintLogInterceptor extends InterceptorsWrapper {
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    // log("<--------------response\n");
    log(' Request URL: ${response.requestOptions.uri.toString()}');
    // log('Request: ${getFullUrl(response.requestOptions.uri.toString(), response.requestOptions.queryParameters)}');
