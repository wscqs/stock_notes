...
class ThemeColor {
  // static ThemeData get data => Theme.of(Get.context!);
  ...
  //自定义的
  static get chatCellBg => GlobalService.to.themeMode != ThemeMode.dark
      ? MaterialTheme.customColor1.light.colorContainer
      : MaterialTheme.customColor1.dark.onColor;
}
