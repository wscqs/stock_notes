...
## 版本更新
v1.0.0 如上完整功能
v1.2.1 多数据导入导出可切换数据源功能(大佬的股票笔记记录等数据可以分享一起学习了）
v1.2.2 iOS 与 Android增加文件直接导入数据源（如分享到微信，其他人微信直接导入到股票笔记 App）
v1.3.0 
股票模块，新增 持有功能
编写笔记部分：设置文字颜色功能优化，体验更佳。
新安装：标签默认加五个。 短期，中期，长期，买，卖. 标签自己可删
删除 500条股票限制
v2.0.1
多账号数据导入导出
股票里面新增持有成本价
笔记那边改颜色体验不好
中文时候：标签默认加五个吧。 短期，中期，长期，买，卖
满足买卖与临近买卖优化下（主要怎么突出）,还要按 时间排序 条件也存进数据库
名言警句功能
v2.0.2 股票信息页增加了打开扫雷web页功能
v2.1.0 新增支持基金（etf)，港股，美股
v2.1.1 笔记支持了图片（警告：纯本地图片，数据迁移图片会丢失）
